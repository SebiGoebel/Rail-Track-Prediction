...
Since \cite{tepNet2024} used this exact model \cite{li2022rail} for the state-of-the-art comparison, shows that generalization is possible with the right dataset.
