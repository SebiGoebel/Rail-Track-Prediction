...
First, observations show that this model, trained on a particular dataset that looks like \autoref{fig:mutlirailTest_a}, cannot generalize for scenes that look different, as shown in \autoref{fig:mutlirailTest_b}.
