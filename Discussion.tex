...
\noindent Since \cite{tepNet2024} used this exact model \cite{li2022rail} for the state-of-the-art comparison, shows that generalization is possible with the right dataset.
...
Since the research of this work and the state-of-the-art comparison of \cite{tepNet2024} showed that the regression approach is superior to classification, a model could regress four rails instead of only two.
