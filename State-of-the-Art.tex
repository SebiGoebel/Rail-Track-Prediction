...
Since, autonomous vehicles are increasingly considered a groundbreaking technology of the future \cite{FraunhoferInstituteforCognitiveSystemsIKS} a lot of work is put in the development of such systems. However often the main focus of this quickly evolving field is on road vehicles, like cars or trucks. Therefore, most publicly available datasets focus on this application and primarily reflect scenarios in road traffic. ~\cite[S.~1221]{railsem19dataset}
...
\textit{CIFAR 100} dataset \cite{cifar100} consists of small images with pixel size 32x32. This dataset includes 600 images with the class label \textit{trains}.

In \textit{PASCAL VOC2012} \cite{pascal2015} there are 544 images labeled "trains".

In the \textit{Microsoft COCO} dataset \cite{Lin2014MicrosoftCC} there are 3745 images with the class "trains". In this dataset there are additional classes like traffic lights and stop sign, however theses are not useful to the task of this work because they are from the street domain and not the rail domain.
...
\textit{Open Images Dataset V4} \cite{openImagesV42018} consists of more than 9.2 million images. the labels of this dataset are bounding boxes. There are 10506 "train"-labels in 9284 images. However there are no other important labels for the rail domain. Additionally the labels also include toy trains, which could present a problem.
...
Semantic segmentation labels are often refereed to as dense or pixel-wise annotated data. These datasets are characterized by the fact that each pixel in their images is assigned to a class.
...
\textit{Cityscapes} \cite{cityscapes2016} is a commonly used dataset for benchmarks when it comes to road scenes. It has 35 different labels of which two are \textit{rail track} and \textit{train}. The \textit{rail track} does not differ between the rails and track bed. 131 \textit{rail track} labels are on 117 images and 194 \textit{trains} are on 167 images in the \textit{Cityscapes} dataset.

\textit{Mapillary Vistas} \cite{mapillaryVistas2017} also has more labels, but only two are rail related ones. \textit{construction-flat-rail-track} is annotated in 710 images and the \textit{object-vehicle-on-rails} label occurs 272 times.
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}{0.328\textwidth}
        \includegraphics[width=\linewidth]{PICs/RailSem19_dataset/RailSem19_Bild1.png}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.328\textwidth}
        \includegraphics[width=\linewidth]{PICs/RailSem19_dataset/RailSem19_Bild2.png}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.328\textwidth}
        \includegraphics[width=\linewidth]{PICs/RailSem19_dataset/RailSem19_Bild3.png}
    \end{subfigure}
    ...
    % Zweite Reihe
    \begin{subfigure}{0.328\textwidth}
        \includegraphics[width=\linewidth]{PICs/RailSem19_dataset/RailSem19_Bild1_GT.png}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.328\textwidth}
        \includegraphics[width=\linewidth]{PICs/RailSem19_dataset/RailSem19_Bild2_GT.png}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.328\textwidth}
        \includegraphics[width=\linewidth]{PICs/RailSem19_dataset/RailSem19_Bild3_GT.png}
    \end{subfigure}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}{0.24\textwidth}
        \centering
        \includegraphics[width=\linewidth]{PICs/railVID_data.png}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.24\textwidth}
        \centering
        \includegraphics[width=\linewidth]{PICs/railVID_label.png}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.24\textwidth}
        \centering
...
%bild einfügen von RailSet und von RailSem19 und von RailSem19 mit zusammengefassten labels.
...
\begin{figure}[ht]
    ...
    \begin{subfigure}{0.3\textwidth}
        \centering
        \includegraphics[width=\linewidth,height=5cm,keepaspectratio]{PICs/RailSet_image.png}
        \caption{}
    ...
    \begin{subfigure}{0.3\textwidth}
        \centering
        \includegraphics[width=\linewidth,height=5cm,keepaspectratio]{PICs/RailSet_GT_rails.png}
        \caption{}
    ...
    \begin{subfigure}{0.3\textwidth}
        \centering
        \includegraphics[width=\linewidth,height=5cm,keepaspectratio]{PICs/RailSet_GT_rails&rail-track.png}
        \caption{}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\linewidth,height=5cm,keepaspectratio]{PICs/RSDS_image.png}
        \caption{}
        \label{fig:RSDS_example_image_GT_a}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\linewidth,height=5cm,keepaspectratio]{PICs/RSDS_GT.png}
        \caption{}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}{0.328\textwidth}
        \centering
        \includegraphics[width=\linewidth,height=5cm,keepaspectratio]{PICs/railDB_fog.png}
    \end{subfigure}
    %\hspace*{0.02\textwidth} % Abstand manuell steuern
    \hfill
    \begin{subfigure}{0.328\textwidth}
        \centering
        \includegraphics[width=\linewidth,height=5cm,keepaspectratio]{PICs/railDB_switch.png}
    \end{subfigure}
    %\hspace*{0.02\textwidth} % Abstand manuell steuern
    \hfill
    \begin{subfigure}{0.328\textwidth}
        \centering
        \includegraphics[width=\linewidth,height=5cm,keepaspectratio]{PICs/railDB_night.png}
    \end{subfigure}
...
\vspace{5cm} % Fügt einen vertikalen Abstand von 5 cm ein
...
\begin{figure}[htbp]
    ...
    % Zweite Reihe
    \begin{subfigure}{0.328\textwidth}
        \includegraphics[width=\linewidth]{PICs/annotated_rs00284.jpg}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.328\textwidth}
        \includegraphics[width=\linewidth]{PICs/annotated_rs00256.jpg}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.328\textwidth}
        \includegraphics[width=\linewidth]{PICs/annotated_rs00198.jpg}
    \end{subfigure}
