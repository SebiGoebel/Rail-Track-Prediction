...
The \textit{Cityscapes} dataset \cite{cityscapes2016} is commonly used for benchmarks regarding road scenes.
...
Even though \cite{li2022rail} presents a interesting approach for solving the rail detection problem,
...
Since, OSDaR23 is captured with nine cameras (\ac{RGB} and \ac{IR}) in different angles, one lidar and one radar sensor, the total number of frames are 1534 * 11 = 16874.
