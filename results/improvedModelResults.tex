...
\begin{table}[H]
    ...
    \resizebox{\textwidth}{!}{
        \begin{tabular}{lcccccc}
            ...
            \hline
            \rowcolor[gray]{0.9} ENB3 \cite{tepNet2024}   & 14.57M            &                & 4.87G          & 24.89 / 15.26 ms        & \textbf{0.9753} & 91.18 \% \\ 
            \rowcolor{white}     RN18 \cite{tepNet2024}   & 15.64M            &                & 9.48G          & 9.48 / 3.25 ms          & 0.9695          & 80.15 \% \\ 
            \hline
...
\begin{table}[H]
    ...
    \begin{minipage}{0.95\textwidth} % Für die Tabelle
        \begin{tabular}{lcccccc}
            ...
            \hline
            \rowcolor[gray]{0.9} ENB3-AP   & 15.35M            & 10.13B         & 5.36G          & 25.64 / 15.25 ms        & 0.9134          & 93.38 \% \\ 
            \rowcolor{white}     RN18-AP   & 16.69M            & 19.49B         & 9.8G           & 10.18 / 3.42 ms         & 0.9658          & 91.18 \% \\ 
