...
\begin{table}[H]
    ...
    \resizebox{\textwidth}{!}{
        \begin{tabular}{lcccccc}
            ...
            \hline
            \rowcolor[gray]{0.9} MNV3-Small & \textbf{5.33M}    & \textbf{0.55B} & \textbf{0.30G} & \textbf{3.13 / 2.05 ms} & 0.9619          & 73.53 \% \\ 
            \rowcolor{white}     MNV3-Large & 7.27M             & 2.15B           & 1.17G          & 6.41 / 3.75 ms          & 0.9649          &  \\ 
            \rowcolor[gray]{0.9} DN121      & 11.42M            & 29.61B         & 15.14G         & 29.53 / 16.52 ms        & 0.9750          &  \\ 
            \rowcolor{white}     DN161      & 30.9M             & 80.74B        & 40.98G         & 75.77 / 34.02 ms        & 0.9746          &  \\ 
            \rowcolor[gray]{0.9} DN169      & 16.96M            & 35.10B         & 17.95G         & 38.87 / 22.51 ms        & 0.9748          &  \\ 
            \rowcolor{white}     DN201      & 22.57M            & 44.83B         & 22.93G         & 52.14 / 29.94 ms        & 0.9751          & \textbf{93.38 \%}  \\
            \hline
        \end{tabular}
    }
...
\begin{table}[H]
    ...
    \begin{minipage}{0.95\textwidth} % Für die Tabelle
        \begin{tabular}{lcccccc}
            ...
            \rowcolor{white}     TEP-RN18      & 15.64M            &                & 9.48G          & 9.48 / 3.25 ms          & 0.9695          & 80.15 \% \\ 
            \rowcolor[gray]{0.9} MNV3-Small    & \textbf{5.33M}    & \textbf{0.55B} & \textbf{0.30G} & \textbf{3.13 / 2.05 ms} & 0.9619          & 73.53 \% \\ 
            \rowcolor{white}     DN201         & 22.57M            & 44.83B         & 22.93G         & 52.14 / 29.94 ms        & 0.9751          & 93.38 \% \\
            \hline
            \rowcolor[gray]{0.9} TEP-ENB3-AP   & 15.35M            & 10.13B         & 5.36G          & 25.64 / 15.25 ms        & 0.9134          & 93.38 \% \\ 
            \rowcolor{white}     TEP-RN18-AP   & 16.69M            & 19.49B         & 9.8G           & 10.18 / 3.42 ms         & 0.9658          & 91.18 \% \\ 
            \rowcolor[gray]{0.9} MNV3-Small-AP & 5.53M             & 0.65B          & 0.35G          & 3.24 / 2.1 ms           & 0.9502          & 58.82 \% \\ 
            \rowcolor{white}     DN201-AP      & -                 & -              & -              & Expected to be high     & -               & - \\ 
            \hline
            \rowcolor[gray]{0.9} TEP-ENB3-MP   & 15.35M            & 10.13B         & 5.36G          & 25.68 / 15.5 ms         & 0.9730          & \textbf{94.85} \% \\ 
            \rowcolor{white}     TEP-RN18-MP   & 16.69M            & 19.49B         & 9.8G           & 9.89 / 3.41 ms          & 0.9688          & 91.91 \% \\ 
