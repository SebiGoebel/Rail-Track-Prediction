...
The next subchapter depicts how true pooling layers affect performance.
After that, the results of experiments with different prediction heads are described.
Each of these subchapters builds on the previous one and results in a final improved single-frame-based model.
