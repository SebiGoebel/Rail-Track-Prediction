...
\begin{table}[H]
    ...
    %\begin{tabular}{| p{0.3\linewidth} | p{0.6\linewidth} |}
        ...
        \hline
        reset rule [40\%] (1/3, 1/2, 1/3)  &            & \checkmark & \checkmark & \checkmark & \checkmark \\
        \hline
...
Version 5 is very similar to Version 2 but instead of starting with the whole image, its initial crop coordinates are set to $(0, 0.1*image\_height, 1)$.
...
The crop is reset to $(1/3, 1/2, 1/3)$.
...
Additionally, the ResNet18 backbone is used because it is the worst-performing one and differences can be observed more easily.
