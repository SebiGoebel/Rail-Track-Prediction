...
While autonomous systems, such as rail track detection, present promising methods to reduce these incidents, many state-of-the-art approaches in the rail domain miss an important distinction between the train's track and adjacent ones.
...
An initial approach tries to combine object detection with semantic segmentation. In the first experiments, object detectors determined switch states. Due to unsatisfactory results, a fundamentally different solution is found. A lightweight model serves as the new baseline that regresses the two rails of the train's path. Enhanced robustness is archived with an improved cropping mechanism responsible for input images and an adapted model architecture.
...
\acknowledgements{
First, I want to thank my parents, who have always supported me throughout my studies. Not only did they provide financial support, making my studies and this work possible in the first place, but they also always had a sympathetic ear for any problems I faced. Furthermore, I want to thank my friends, who helped me through challenging times. I am especially grateful to Markus Nesetril, who was always there for me during tough times and helped me find balance through physical activities.

A huge thank you also goes to the guys from the CD lab: Mattias Bittner, Mattias Wess, Dominik, and Martin Lechner. A very special thanks goes to Daniel Schnöll, who sat at the desk next to me during this work and always had answers to my quick questions. And above all, I owe an enormous thank you to David Breuss, who co-supervised this thesis. The almost daily exchanges with him greatly helped me in writing this work.
}
